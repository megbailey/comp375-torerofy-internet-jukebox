...
public class AudioPlayerThread implements Runnable {
    public final int MAX_DATA_SIZE = 20000;
    public final int MAX_SEG_SIZE = 20287;
    public final int MAX_HEADER_SIZE = 287;
	...
	public void run() {
		try {
			final byte[] dataArray = new byte[MAX_DATA_SIZE];
